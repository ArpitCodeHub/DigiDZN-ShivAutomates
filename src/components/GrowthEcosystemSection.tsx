...
const nodes: EcoNode[] = [
  ...
  { id: 4, label: 'Branding',             icon: '✨', color: '#8b5e3c', connections: [2,3,5,6], image: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=600&q=80&auto=format&fit=crop', description: 'Distinctive brand identity and positioning that commands attention and builds lasting recognition.' },
