...
const nodes: EcoNode[] = [
  { id: 1, label: 'SEO',              icon: '01', color: '#a87242', connections: [2,3,5,7], image: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=600&q=80&auto=format&fit=crop', description: 'Organic visibility through precision keyword strategy, technical optimization, and content authority.' },
  { id: 2, label: 'GEO',              icon: '02', color: '#c89368', connections: [1,4,7],   image: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600&q=80&auto=format&fit=crop', description: 'Hyper-local targeting that puts your brand in front of the right audience at the right location.' },
  { id: 3, label: 'Content',          icon: '03', color: '#d4a576', connections: [1,4,6],   image: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=600&q=80&auto=format&fit=crop', description: 'Strategic content that attracts, educates, and converts your ideal customers at every funnel stage.' },
  { id: 4, label: 'Branding',         icon: '04', color: '#8b5e3c', connections: [2,3,5,6], image: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=600&q=80&auto=format&fit=crop', description: 'Distinctive brand identity and positioning that commands attention and builds lasting recognition.' },
  { id: 5, label: 'Websites',         icon: '05', color: '#a87242', connections: [1,4,7],   image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=600&q=80&auto=format&fit=crop', description: 'High-converting web experiences engineered for performance, UX, and lead generation.' },
  { id: 6, label: 'Social',           icon: '06', color: '#c89368', connections: [3,4],     image: 'https://images.unsplash.com/photo-1611605698335-8b1569810432?w=600&q=80&auto=format&fit=crop', description: 'Community-building and engagement strategies that amplify reach and deepen brand loyalty.' },
  { id: 7, label: 'Performance\nMkt', icon: '07', color: '#d4a576', connections: [1,2,5],   image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80&auto=format&fit=crop', description: 'Data-driven paid advertising that maximises ROI and scales your growth predictably.' },
]
          ...
          {nodes.map((node, i) => (
            ...
            >
              ...
              <div className="p-4 sm:p-5 -mt-7 relative">
                <div
                  className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-3 border-2 border-[#0a0807]"
                  style={{ background: node.color }}
                >
                  <span className="font-black text-[#0a0807] text-xs tracking-wider">{node.icon}</span>
                </div>
                <h3 className="font-black text-white text-sm sm:text-base leading-tight tracking-wide uppercase whitespace-pre-line">
                  {node.label}
                </h3>
              </div>
                  ...
                  <div className="md:flex items-start gap-8 lg:gap-10">
                    <div className="flex-1 mb-6 md:mb-0">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-lg sm:text-xl font-black text-white tracking-wide uppercase">{node.label.replace('\n', ' ')}</h3>
                      </div>
