...
export default function AboutSection() {
  return (
    <Section id="about" className="py-24 md:py-32 bg-[#0a0807]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[480px] md:h-[560px]">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute right-4 top-[18%] text-white/70 text-3xl"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute left-2 top-[42%] w-10 h-10"
              style={{
                background: '#a87242',
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute right-[20%] top-[45%] text-[#c89368] text-4xl"
            >
              ✺
            </motion.div>
          ...
          <div>
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight mb-3"
            >
            ...
            <motion.h3
              ...
              viewport={{ once: true }}
              className="font-serif-italic text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight mb-10"
              style={{ color: '#d4a576' }}
            >
              go digital,<br />
              stay efficient,<br />
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="space-y-5 max-w-md text-white/65 leading-relaxed mb-10"
            >
              <p>
            ...
            <motion.button
              ...
              className="px-7 py-3 rounded-full text-sm md:text-base text-white border border-white/25 bg-white/5 backdrop-blur-sm transition-colors"
            >
              More about agency
            </motion.button>
          </div>
